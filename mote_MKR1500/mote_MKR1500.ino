...
#define HOSTNAME "cm21" // must be unique for all motes on network
#define TOPIC_OUTGOING "cm21/outgoing" // measurements published on this topic
#define TOPIC_SHADOW_UPDATE "$aws/things/Arduino_CM21/shadow/update" // used to report the updated shadow state
#define TOPIC_SHADOW_OUT "$aws/things/Arduino_CM21/shadow/get" // used for Arduino to ask AWS to publish shadow state, which is then published on:...
#define TOPIC_SHADOW_IN "$aws/things/Arduino_CM21/shadow/get/accepted" // ...this one
#define CERT CM21_CERTIFICATE
